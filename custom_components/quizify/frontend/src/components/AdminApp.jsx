...
export function AdminApp({ hass }) {
  ...
  // Load categories + speakers when hass becomes available.
  useEffect(() => {
          ...
          <div className="qz-stack">
            ...
            <div className="qz-stack">
              ...
              <div className="qz-muted" style={{ fontSize: 12 }}>
                If set, funny TTS announcements will play before the game starts and when a winner is declared. Use the same speaker as background music for best results.
              </div>
            </div>
            <button
              type="button"
